...
def test_market_states_pipeline_writes_outputs(tmp_path) -> None:
    ...
    pd.DataFrame(
        {
            "Structure_ID": ["STR_000001", "STR_000002", "STR_000003"],
            "Symbol": ["EURUSD", "EURUSD", "EURUSD"],
            "Timeframe": ["M5", "M5", "M5"],
            "Start_Time": pd.date_range("2026-01-01", periods=3, freq="5min"),
            "End_Time": pd.date_range("2026-01-01 00:05:00", periods=3, freq="5min"),
            "Direction": ["UP", "DOWN", "NEUTRAL"],
            "Lifecycle_Stage": ["MATURITY", "FORMATION", "DEVELOPMENT"],
            "Persistence_Index": [0.6, 0.4, 0.2],
            "Structural_Complexity": [0.4, 0.5, 0.4],
            "Structural_Stability": [0.8, 0.7, 0.7],
            "Structural_Efficiency": [0.7, 0.4, 0.2],
            "Event_Density": [0.5, 0.4, 0.3],
            "Structural_Volatility": [0.3, 0.4, 0.2],
            "Structural_Symmetry": [0.8, 0.8, 0.8],
            "Structural_Confidence": [0.8, 0.75, 0.7],
            "Duration_Seconds": [300, 300, 300],
            "Price_Displacement": [0.001, -0.0004, 0.0],
            "Event_Count": [8, 7, 6],
            "Leg_Count": [4, 3, 2],
        }
    ...
    assert result.structures_processed == 3
    assert result.states_generated == 3
