...
from sqre.h4_transition_scenario_dispersion_review.findings import profile_diagnostic, profile_follow_up
...
def build_profile_dispersion_diagnostics(
    ...
    for stat in sorted(statistics, key=lambda item: (item.condition_label, item.forward_window)):
        ...
        readiness = transition_profile_readiness_class(
        ...
        diagnostics.append(
            ProfileDispersionDiagnostic(
                ...
                source_state=stat.source_state,
                target_state=stat.target_state,
                transition_family=stat.transition_family,
                ...
                transition_profile_readiness_class=readiness,
