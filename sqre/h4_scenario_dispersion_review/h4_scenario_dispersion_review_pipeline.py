"""Pipeline for H4 scenario dispersion review."""
...
from sqre.h4_scenario_dispersion_review.classification import h4_aggregation_readiness_flag
from sqre.h4_scenario_dispersion_review.config import H4ScenarioDispersionReviewConfig
from sqre.h4_scenario_dispersion_review.findings import h4_summary_diagnostic, h4_summary_follow_up
...
from sqre.h4_scenario_dispersion_review.models import (
    ...
    H4ScenarioDispersionReviewSummary,
...
from sqre.h4_scenario_dispersion_review.reports import write_review_outputs
...
from sqre.h4_scenario_dispersion_review.window_dispersion import build_window_dispersion_summary, mean


def run_h4_scenario_dispersion_review(
    input_dir: Path | str,
    output_dir: Path | str,
    report_path: Path | str,
    config: H4ScenarioDispersionReviewConfig | None = None,
) -> H4ScenarioDispersionReviewResult:
    active_config = config or H4ScenarioDispersionReviewConfig()
    ...
    state_summaries = build_state_dispersion_summary(diagnostics)
    window_summaries = build_window_dispersion_summary(diagnostics)
    ...
    result = H4ScenarioDispersionReviewResult(
...
def _build_summary(
    ...
    return H4ScenarioDispersionReviewSummary(
        timeframe="H4",
        ...
        h4_dispersion_profile=_dominant_dispersion_label(high, moderate, stable),
        h4_aggregation_readiness_flag=readiness,
        h4_scenario_dispersion_diagnostic=h4_summary_diagnostic(
