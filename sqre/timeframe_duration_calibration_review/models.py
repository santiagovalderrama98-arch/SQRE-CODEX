"""Models for H1/M5 duration calibration review."""
...
@dataclass(frozen=True)
class DurationReviewResult:
    input_experiment_summary: str
    rows_loaded: int
    timeframes_reviewed: int
    profiles_reviewed: int
    output_path: Path
    report_path: Path
    rows: list[DurationReviewRow] = field(default_factory=list)
