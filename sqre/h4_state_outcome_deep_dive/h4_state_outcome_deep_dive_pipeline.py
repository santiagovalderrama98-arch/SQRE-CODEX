"""Pipeline for H4 research-ready state outcome deep dive."""
...
from sqre.h4_state_outcome_deep_dive.models import H4StateOutcomeDeepDiveResult
...
from sqre.h4_state_outcome_deep_dive.reports import build_state_deep_dive_summary, write_deep_dive_outputs
from sqre.h4_state_outcome_deep_dive.scenario_breakdown import build_scenario_breakdown


def run_h4_state_outcome_deep_dive(
    h4_d1_research_dir: Path | str,
    validation_output_dir: Path | str,
    output_dir: Path | str,
    report_path: Path | str,
    config: H4StateOutcomeDeepDiveConfig | None = None,
) -> H4StateOutcomeDeepDiveResult:
    active_config = config or H4StateOutcomeDeepDiveConfig()
    ...
    selected = select_h4_state_profiles(price_profiles, active_config)
    ...
    result = H4StateOutcomeDeepDiveResult(
