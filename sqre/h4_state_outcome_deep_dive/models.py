"""Models for H4 state outcome deep dive."""
...
@dataclass(frozen=True)
class H4StateDeepDiveSummaryRow:
    condition_label: str
    profile_count: int
...
@dataclass(frozen=True)
class H4StateOutcomeDeepDiveResult:
    ...
    selected_profiles: list[H4StateProfile] = field(default_factory=list)
    ...
    summary_rows: list[H4StateDeepDiveSummaryRow] = field(default_factory=list)
