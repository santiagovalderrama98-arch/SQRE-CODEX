"""Scenario comparison matrix for H4 state profiles."""

from __future__ import annotations

from sqre.h4_state_outcome_deep_dive.config import H4StateOutcomeDeepDiveConfig
from sqre.h4_state_outcome_deep_dive.findings import scenario_comparison_diagnostic, scenario_deviation_class
from sqre.h4_state_outcome_deep_dive.models import OutcomeStatisticsRow, ScenarioBreakdownRow, ScenarioComparisonRow
